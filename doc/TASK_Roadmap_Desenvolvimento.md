...
- [ ] **Modelar telefone fixo (à esquerda da mesa)**
...
- [ ] **Modelar celular sobre a mesa (canto inferior)**
...
- [ ] **Xícara de café com vapor (partículas)**
...
- [ ] **Porta-retrato com foto da esposa**
...
- [ ] **Post-its colados na borda do monitor**
...
- [ ] **Teclado + mouse no primeiro plano**
...
- [ ] **Transição suave entre modos (lerp de posição e rotação)**
...
- [~] **Limites do OrbitControls (azimuth, polar, distância)**
